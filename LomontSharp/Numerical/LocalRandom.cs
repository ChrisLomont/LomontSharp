...
namespace Lomont.Numerical
{
    ...
    public class LocalRandom
    {
        ...
        /// </summary>
        /// <param name="largePeriod">Use 2^128 bit (slower) or 2^64 bit period (faster) rng</param>
        /// <param name="lowSeed">low 64 bits of seed value</param>
        /// <param name="highSeed">high 64 bits of seed value</param>
